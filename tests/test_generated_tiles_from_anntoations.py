...
from celer_sight_ai.QtAssets.Utilities.data_handler import overlaps, build_graph, get_tile_range_from_annotation_size, find_minimum_groups, get_tile_range_from_group
logger = logging.getLogger(__name__)
DELAY_TIME = 200


def validate_all_intervals_overlap(grouped_keys:list = None , intervals: dict = None) -> bool:
...
class TestCategoryConfigs(unittest.TestCase):
    def test_case_1(self):
        ...
        widths = {w : get_tile_range_from_annotation_size(widths[w],MIN_PERCENTAGE , MAX_PERCENTAGE ) for w in widths}
        print(widths)
