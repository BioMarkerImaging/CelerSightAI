...
class AddButtons(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        super(AddButtons, self).__init__(parent)
    ...
    def import_images_with_file_dialog(self, folder_to_read_images_from=None):
        ...
        from celer_sight_ai.QtAssets.Utilities.file_explorer_dialogs import (
    ...
    def append_video_object_to_data_handler(self, signal_object):
        from celer_sight_ai.QtAssets.Utilities.scene import readImage, image_to_uint8
        import numpy as np
        import time
    ...
    def SetUpButtons(
        ...
        """
        from celer_sight_ai.QtAssets.Utilities.scene import is_video_file
        import numpy as np
        from celer_sight_ai import config
