...
import cv2
from celer_sight_ai.QtAssets.Utilities.Workers import Worker, WorkerSignals
from celer_sight_ai.QtAssets.Utilities.ProgressD import Ui_Progress_dialog
import numpy as np
...
class Ui_AnalysisDialog(QtWidgets.QDialog):
    ...
    def gather_all_analysis_data_in_a_df(self):
        ...
        from celer_sight_ai.QtAssets.Utilities.data_handler import ImageObject
