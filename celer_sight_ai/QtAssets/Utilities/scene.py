...
class PhotoViewer(QtWidgets.QGraphicsView):
    ...
    def __init__(self, MainWindow=None):
        ...
        from celer_sight_ai.QtAssets.popup_tool_menu_Handler import (
        ...
        from celer_sight_ai.QtAssets.Utilities.QitemTools import quickToolsUi
    ...
    def add_inference_tile_graphics_item(self, object):
        ...
        """
        from celer_sight_ai.QtAssets.animate_processing_bbox import (
            ProcessingBox,
        )
    ...
    def add_partial_slide_images_to_scene(self, object):
        ...
        None
        """
        from celer_sight_ai.QtAssets.Utilities.image_reader import DEEPZOOM_TILE_SIZE
        import heapq
    ...
    def threadedBoundingBoxStopWorkerResultFunction(self):
        # self.mylabelAnimaction.completeLoad()
    ...
    def draw_bounding_box_stop(
        ...
        self.aa_review_state = False
        from celer_sight_ai.QtAssets.Utilities.sdknn import mask_to_polygon
        ...
        from celer_sight_ai.AiAA import calculate_polygon_width
    ...
    def switchToQuickTools_RF_MODE(self, mode=True):
        if mode == True:
            ...
            self.mylabelAnimaction = labelAnimation(
                self.MainWindow, preOption="PreprocessingOption"
            )
            ...
            if self.MainWindow.counter_tmp > 3:
                ...
                if (
                    ...
                    if self.POLYGON_MODIFY_MODE == None:
                        ...
                        from AA_cls import GetPointsFromQPolygonF
