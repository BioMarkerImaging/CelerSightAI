...
if __name__ == "__main__":
    ...
    Dialog_for_category_creation = QtWidgets.QDialog()
    ui = Ui_Dialog_for_category_creation()
    ui.setupUi(Dialog_for_category_creation)
    Dialog_for_category_creation.show()
    sys.exit(app.exec())
