...
class SquareButton(QPushButton):
    ...
    def __init__(
        ...
        from celer_sight_ai.gui.custom_widgets.pro_lite_model_toggle_component import (
...
class FilterableClassList(FilterableIconTable):
    ...
    def __init__(self, items, icon_size=40, *args, **kwargs) -> None:
        ...
        from celer_sight_ai.gui.custom_widgets.stylized_widget import StylableButton
