# ../celer_sight_ai/UiAssets/pg1_widget_mask_settings.ui'
#
...
class Ui_pg1_settings_widget(object):
    def setupUi(self, pg1_settings_widget):
        ...
        self.pg1_MaskAttributes_ApplyToEmpty = QtWidgets.QPushButton(
            parent=self.pg1_MaskAttributes_groupBox_ToolBox
        )
        ...
        self.pg1_green_channel_button_visual = QtWidgets.QPushButton(
            parent=self.pg1_channels_groupBox_ToolBox
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum
        )
        ...
        self.pg1_settings_lasso_remove_button = QtWidgets.QPushButton(
            parent=self.pg1_settings_groupBox_ToolBox
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum
        )
        ...
        self.pg1_settings_all_masks_color_width_label = QtWidgets.QLabel(
            parent=self.frame_2
        )
        ...
        self.frame = QtWidgets.QFrame(parent=self.pg1_settings_groupBox_mask_appearance)
        ...
        self.pg1_settings_selected_mask_color_button = QtWidgets.QPushButton(
            parent=self.frame
        )
        ...
        self.pg1_settings_selected_mask_color_width_label = QtWidgets.QLabel(
            parent=self.frame
        )
