# ../celer_sight_ai/UiAssets/MaskButtonWidgetSofia.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setStyleSheet("QFrame#MaskWidgetFrame\n"
"{\n"
"    \n"
...
"")
        ...
        self.EyeWidgetFrame = QtWidgets.QFrame(parent=Form)
        ...
        self.EyeIcon = QtWidgets.QPushButton(parent=self.EyeWidgetFrame)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(" UiAssets/../../../.designer/data/icons/Eye.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.MaskWidgetFrame = QtWidgets.QFrame(parent=Form)
        self.MaskWidgetFrame.setStyleSheet("selection-background-color: rgb(182, 182, 182);")
        ...
        self.ArrayPropertiesWidgetbtn = QtWidgets.QPushButton(parent=self.MaskWidgetFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ArrayPropertiesWidgetbtn.sizePolicy().hasHeightForWidth())
        ...
        self.MaskPropertiesWidgetbtn = QtWidgets.QPushButton(parent=self.MaskWidgetFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MaskPropertiesWidgetbtn.sizePolicy().hasHeightForWidth())
        ...
        self.MaskPropertiesWidgetLabelcomboBox = QtWidgets.QLabel(parent=self.MaskWidgetFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MaskPropertiesWidgetLabelcomboBox.sizePolicy().hasHeightForWidth())
        self.MaskPropertiesWidgetLabelcomboBox.setSizePolicy(sizePolicy)
        self.MaskPropertiesWidgetLabelcomboBox.setObjectName("MaskPropertiesWidgetLabelcomboBox")
