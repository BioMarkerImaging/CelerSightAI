# ../celer_sight_ai/UiAssets/overview_tabs_widget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.overview_tabs = QtWidgets.QTabWidget(parent=Form)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum
        )
        sizePolicy.setHorizontalStretch(0)
        ...
        self.mask_preview_scrollArea = QtWidgets.QScrollArea(
            parent=self.overview_tabs_mask
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum
        )
        ...
        self.MaskLabelAreaAddRemove = QtWidgets.QFrame(parent=self.overview_tabs_mask)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum
        )
        sizePolicy.setHorizontalStretch(0)
        ...
        self.MaskLabelAddToCombobox = QtWidgets.QPushButton(
            parent=self.MaskLabelAreaAddRemove
        )
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        self.MasterMaskLabelcomboBox = QtWidgets.QComboBox(
            parent=self.MaskLabelAreaAddRemove
        )
